...
data = pd.read_csv('5nodes/result_test_n=5_100000.csv', header=-1)#, delimiter='\t')
...
for i in range(3):
    ...
    model = Sequential()
    model.add(Dense(60, input_dim=30, activation='relu', kernel_initializer='he_uniform'))
    #model.add(BatchNormalization())
...
class_pred.to_csv("5nodes/class_prediction_5nodes_50epochs_reg_th015.csv")
class_label.to_csv("5nodes/class_label_5nodes_50epochs_reg_th015.csv")
reg_pred.to_csv("5nodes/reg_prediction_5nodes_50epochs_reg_th015.csv")
reg_label.to_csv("5nodes/reg_label_5nodes_50epochs_reg_th015.csv")
result.to_csv("5nodes/results_50epochs_reg_th015.csv")
...
with open("5nodes/model.json", "w") as json_file:
